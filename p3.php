...
if(isset($_POST['btn'])){
    ...
    // $email=$_POST["add"];
        ...
        $sql="INSERT INTO `cart`(prod_id,Qty,price,prodname) values(3,1,68,'Hemp Tees')";
  ...
  <selection id="product1" class="section-p1">
     ...
     <div class="pro">
       ...
       <center> <div class="des"><form method="post">
            <span>Adidas</span>
            <h5>Hemp Tees</h5>
            <p>Introducing Adidas Hemp Tees, a fusion of sporty sophistication and sustainable style. Crafted from premium hemp fabric, these tees offer superior comfort and breathability while making a bold statement for eco-conscious fashion. With the iconic Adidas logo and innovative designs, elevate your wardrobe with Adidas Hemp Tees and embrace a greener, more stylish future.
</p>
