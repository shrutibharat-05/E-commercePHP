...
if(isset($_POST['btn'])){
    ...
    // $email=$_POST["add"];
        ...
        $sql="INSERT INTO `cart`(prod_id,Qty,price,prodname) values(2,1,88,'Graphic Tees')";
...
<body>
  ...
  <selection id="product1" class="section-p1">
    <center>
  <div class="pro">
        <img src="https://github.com/tech2etc/Build-and-Deploy-Ecommerce-Website/blob/main/img/products/f2.jpg?raw=true" alt="">
        <div class="des"><form method="post">
            <span>Crocodile</span>
            <h5>Graphic Tees</h5>
            <p>Introducing "Crocodile Graphic Tees" - a collection that embodies the spirit of the wild with a touch of urban flair. Our Crocodile Graphic Tees are not just garments; they're statements of style and attitude, perfect for those who dare to stand out from the crowd.

Crafted with premium quality materials, our graphic tees offer unmatched comfort and durability. Each design features intricate artwork showcasing the majestic beauty and power of crocodiles, meticulously printed to capture every detail. From fierce snarls to graceful movements, our tees bring these fascinating creatures to life in vibrant colors and bold compositions.</p>
        <h4>$88</h4>
        </div>
